...
class SetGame: ObservableObject {
    ...
    struct ViewCard: ViewCardable, Cardable {
        ...
        static var exampleSquiggleOne = ViewCard(color: .red, quantity: 1, cardShape: .squiggle, cardShading: .none, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
        static var exampleSquiggleTwo = ViewCard(color: .red, quantity: 2, cardShape: .squiggle, cardShading: .solid, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
        static var exampleSquiggleThree = ViewCard(color: .red, quantity: 3, cardShape: .squiggle, cardShading: .striped, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
        static var exampleDiamondOne = ViewCard(color: .red, quantity: 1, cardShape: .diamond, cardShading: .none, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
        static var exampleDiamondTwo = ViewCard(color: .red, quantity: 2, cardShape: .diamond, cardShading: .solid, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
        static var exampleDiamondThree = ViewCard(color: .red, quantity: 3, cardShape: .diamond, cardShading: .striped, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
        static var exampleOvalOne = ViewCard(color: .red, quantity: 1, cardShape: .oval, cardShading: .none, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
        static var exampleOvalTwo = ViewCard(color: .red, quantity: 2, cardShape: .oval, cardShading: .solid, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
        static var exampleOvalThree = ViewCard(color: .red, quantity: 3, cardShape: .oval, cardShading: .striped, isDealt: true, isFaceUp: true, isSelected: false, isMatched: false, wasUsed: false, id: UUID())
